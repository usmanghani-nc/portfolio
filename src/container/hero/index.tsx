...
const media: IMedia[] = [
  ...
  { href: 'https://www.linkedin.com/in/muhammad-usman-ghani-92a97b195/', text: 'Linkdin' },
];
    ...
    <Page>
      <div className="flex flex-col md:justify-center items-center p-4 pt-20 md:p-0">
        ...
        <div className="mt-5 md:mt-10 text-center">
          <p className="text-primary-text font-thin text-2xl md:text-4xl  md:mb-2">Hi, there👋</p>
